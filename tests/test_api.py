...
class TestWebimagescraperAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = WebimagescraperAPIClient(self.api_key)

    @patch('apiverve_websiteimagesscraper.apiClient.requests.get')
